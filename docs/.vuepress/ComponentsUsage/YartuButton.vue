  ...
  computed: {
    buttonClass() {
      return [
        ...
        {
          "!bg-[#3663f2] text-white hover:!bg-[#0E3DD3ff] disabled:!bg-[#dae3f1ff]":
            this.primary,
          "border !border-[#e5ebf5ff] !bg-white !text-[#3663f2ff] hover:!bg-[#ebf0feff] disabled:!bg-[#f4f5f6ff]":
            this.secondary,
          "!bg-[#394c66ff] text-white hover:!bg-[#161d27ff] disabled:!bg-[#f4f5f6ff] disabled:border-BORDER disabled:border":
            this.tertiary,
          "!bg-[#eb6363ff] text-white hover:!bg-[#E93F3F] disabled:opacity-50":
            this.error,
          "!bg-[#49ab5eff] text-white hover:!bg-[#6ED37Eff] disabled:opacity-50":
            this.success,
          "!text-[#3663f2ff] hover:underline disabled:!text-[#f4f5f6ff] !p-0":
            this.text,
